      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {!isLogin && (
              <>
                ...
                >
                  ...
                  {googleLoading ? t("auth.loading") : t("auth.google_signup")}
                </Button>
              </>
            )}
            ...
            <Button
              type="submit"
              className={`w-full ${!isLogin ? "bg-primary hover:bg-primary/90" : ""}`}
              disabled={loading}
            >
          ...
          {isLogin && (
            <>
              ...
              >
                ...
                {googleLoading ? t("auth.loading") : t("auth.google_login")}
              </Button>
            </>
          )}
