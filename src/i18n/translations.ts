...
export const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    "index.medical_articles": "Artículos de Salud",
    ...
    "actions.share_linkedin": "Compartir en LinkedIn",
  ...
  en: {
    ...
    "index.medical_articles": "Health Articles",
    ...
    "actions.view": "View",
    "actions.share": "Share",
    "actions.share_linkedin": "Share on LinkedIn",
